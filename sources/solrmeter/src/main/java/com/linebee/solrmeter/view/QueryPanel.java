...
import com.linebee.solrmeter.controller.QueryPanelController;
...
public class QueryPanel extends StatisticPanel {
	...
	private final static int INPUT_PANEL_WIDTH = 200;
	...
	private void initGUI() {
		...
		this.add(this.createOutputPanel());
		this.add(this.createErrorLabel());
	}
