 ...
 */
package com.linebee.solrmeter.statistic.parser;
...
import com.linebee.solrmeter.controller.statisticsParser.ParserException;
...
public class StatisticsParserCastorImplTestCase extends BaseTestCase {
	...
	public void testSimple() {
		try {
			...
			assertEquals(com.linebee.solrmeter.view.statistic.HistogramChartPanel.class, descriptor1.getViewClass());
			assertEquals(com.linebee.solrmeter.mock.MockStatistic.class, descriptor1.getModelClass());
